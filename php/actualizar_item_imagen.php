...
$sql1="UPDATE items SET nombre_comercial='$nombre_comercial', laboratorio = '$laboratorio', monodroga='$monodroga',  precio = '$precio', cobertura_pami = '$cobertura_pami', url_img = '$url_img', codigo_interno = '$codigo_interno', descuento_lista = '$descuento_lista' WHERE id='$id_item'";
